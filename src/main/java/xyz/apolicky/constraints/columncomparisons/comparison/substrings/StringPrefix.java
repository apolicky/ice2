...
@Component
public class StringPrefix implements TwoColumnComparisonOperation, NewTwoColComparisonIfce {
    public static final String id = "string-prefix";
    ...
    public RowWiseCellComparison compare(Object leftObj, Object rightObj) {
        ...
        if (right.startsWith(left)) {
            return RowWiseCellComparison.PREFIX;
        }
        return null;
    }
