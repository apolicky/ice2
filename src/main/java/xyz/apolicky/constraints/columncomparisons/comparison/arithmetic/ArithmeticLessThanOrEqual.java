...
@Component
public class ArithmeticLessThanOrEqual implements TwoColumnComparisonOperation, NewTwoColComparisonIfce {

    public static final String id = "arithm-less-than-or-equal";
