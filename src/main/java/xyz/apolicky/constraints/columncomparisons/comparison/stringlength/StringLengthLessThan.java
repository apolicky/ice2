...
@Component
public class StringLengthLessThan implements TwoColumnComparisonOperation, NewTwoColComparisonIfce {
    public static final String id = "string-length-less-than";
