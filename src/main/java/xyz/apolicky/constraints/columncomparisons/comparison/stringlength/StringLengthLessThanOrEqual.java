...
@Component
public class StringLengthLessThanOrEqual implements TwoColumnComparisonOperation, NewTwoColComparisonIfce {
    public static final String id = "string-length-less-than-or-equal";
