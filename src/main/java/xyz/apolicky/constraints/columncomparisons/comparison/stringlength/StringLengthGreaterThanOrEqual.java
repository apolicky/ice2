...
@Component
public class StringLengthGreaterThanOrEqual implements TwoColumnComparisonOperation, NewTwoColComparisonIfce {
    public static final String id = "string-length-greater-than-or-equal";
