...
@Component
public class StringLengthGreaterThan implements TwoColumnComparisonOperation, NewTwoColComparisonIfce {
    public static final String id = "string-length-greater-than";
